"""
Django settings for tred_46548 project.
...
WSGI_APPLICATION = 'tred_46548.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tred_46548 API",
    "DESCRIPTION": "API documentation for tred_46548 App",
    "VERSION": "v1",
}
